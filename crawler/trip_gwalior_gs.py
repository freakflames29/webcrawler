...
class TripGwaGs:
    ...
    def google_scholar(self, name, id):
        ...
        for name in names:
            ...
            for meta in metas:
                if "ABV-IIITM Gwalior".casefold() in meta.get(
                        'content').casefold() or "Atal Bihari Vajpayee Indian Institute of Information Technology and Management, Gwalior".casefold() in meta.get(
                        'content').casefold():
                    mycur = mydb.cursor()
